...
find "./terraform/vpc-ec2" -type d -name '.terraform' -exec rm -rf {} \;
find "./terraform/vpc-ec2" -type f -name 'terraform.tfstate' -exec rm -f {} \;
find "./terraform/vpc-ec2" -type f -name 'terraform.tfstate.backup' -exec rm -f {} \;
